...
// If you use several lidars, you can use this code to merge their point clouds

// these three head file is for synchronizing lidar point cloud
  ...
  node_handle_(), private_node_handle_("~"), tf_listener_()
{
  ...
  cloud_synchronizer_ = new message_filters::Synchronizer<SyncPolicyT>(SyncPolicyT(10),
                                                                       *cloud_subscribers_[0], *cloud_subscribers_[1],
                                                                       *cloud_subscribers_[2], *cloud_subscribers_[3],
                                                                       *cloud_subscribers_[4], *cloud_subscribers_[5],
                                                                       *cloud_subscribers_[6], *cloud_subscribers_[7]);
  // can synchronize at most 8 point cloud

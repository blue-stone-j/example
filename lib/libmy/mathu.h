...
static int transformLine(const LineModel &model_in, LineModel &model_out, const Eigen::Affine3d &pose)
{
...
static int transformPlane(const PlaneModel &model_in, PlaneModel &model_out, const Eigen::Affine3d &pose)
{
